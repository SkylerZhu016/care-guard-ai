...
TEST_FALLBACK: List[Dict[str, str]] = [
    {"guidelineId": "project-red-flags", "versionId": "red-flags-v2", "chunkId": "chunk-red-flag-chest-pain-001",
     "title": "成人急症红旗识别教学材料", "section": "胸痛伴随危险信号", "sourceUrl": "https://example.org/medsim/synthetic-red-flag-demo",
     "licenseNote": "项目自制合成教学材料", "quote": "教学模拟中，胸痛伴呼吸困难、晕厥或意识异常属于需要立即人工急症评估的红旗组合。"},
    {"guidelineId": "project-red-flags", "versionId": "red-flags-v2", "chunkId": "chunk-red-flag-consciousness-001",
     "title": "成人急症红旗识别教学材料", "section": "意识状态", "sourceUrl": "https://example.org/medsim/synthetic-red-flag-demo",
     "licenseNote": "项目自制合成教学材料", "quote": "新发意识异常或晕厥应作为高优先级红旗信号进入人工评估，不应由自动系统给出低风险结论。"},
    {"guidelineId": "who-hearts-2020", "versionId": "who-hearts-teaching-v1", "chunkId": "chunk-routine-followup-001",
     "title": "HEARTS Technical Package", "section": "基层高血压工程化随访摘要", "sourceUrl": "https://www.who.int/publications/i/item/9789240001367",
     "licenseNote": "公开访问；再利用以 WHO 发布页为准", "quote": "无急症红旗的教学病例可由医务人员结合结构化信息安排常规复核；自动结果不能替代人工判断。"},
]
