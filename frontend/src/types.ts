...
export interface SymptomReport { id?:string; symptomCode: string; name?: string; customName?:string; source: 'USER_SELECTED'|'AI_EXTRACTED'|'CATALOG'|'RELATED_ANSWER'|'CUSTOM'|'LEGACY'; catalogVersion?:string; supportLevel?:SupportLevel; onsetRange?:string; course?:string; currentStatus?:string; activityImpact?:string; answers:QuestionAnswer[]; legacySeverity?:number; legacyOnset?:string }
