...
<template>
  <section class="workspace admin-workspace">
    <div class="page-heading"><div><span class="eyebrow">GOVERNANCE & OBSERVABILITY</span><h1>安全与审计中心</h1><p>先看异常与整体健康，再按需展开知识来源、运行轨迹和审计细节。</p></div><span class="simulation-badge dark">知识 pgvector-kb-v3 · 规则 red-flags-v1</span></div>
